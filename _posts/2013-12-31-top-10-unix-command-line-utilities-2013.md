...
Here a substitution operation is used to cut of the extension part which is then replaced with the
...
This will move all files into folders that have the same name as their extension. The `-p` is needed
